<template>
    <div>
        <nav class="fixed w-full text-white mx-0 px-3 z-50">
            <div class="flex flex-row items-center justify-between font-Plus drop-shadow-xl text-3xl">
                <div class="bg-black rounded-full p-4 cursor-pointer">
                    <div v-if=showMenu>
                ...
                <div v-show="showMenu">
                    <h3 class="hidden bg-black font-light rounded-full py-3 px-6 text-3xl tracking-wider transition-all duration-500 sm:block md:tracking-widest">
                        architecture
                    </h3>
                </div>
                <router-link to="/">
                    <div class="bg-black rounded-full p-3">
                        <p class="text-6xl font-light text-black bg-white rounded-full px-3 py-7 transition-all duration-500 hover:bg-slate-200">W2</p>
                    </div>
                </router-link>
                <div v-show="showMenu">
                    <h3 class="hidden bg-black font-light rounded-full py-3 px-6 text-3xl tracking-wider transition-all duration-500 sm:block md:tracking-widest">
